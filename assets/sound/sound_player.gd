...
const BLOCK_BUMP : AudioStream = preload("res://assets/sound/sounds/block_bump.wav")
const BLOCK_BREAK : AudioStream = preload("res://assets/sound/sounds/block_break.wav")
const BLOCK_BREAK2 : AudioStream = preload("res://assets/sound/sounds/block_break2.wav")
