...
@export var move_data : PlayerMovementData = preload("res://src/Player/Resources/pmd_default.tres") as PlayerMovementData
...
func _unhandled_input(event: InputEvent) -> void:
	...
	if Input.is_action_pressed("move_up") and door != null:
		door.enter_door()
